...
from data_bot.main import DEFAULT_SOUNDS_PATH, DUMP_SOUNDS_PATH, INTRO_STRING, data_bot_speak, read_emp_data, respond
import pandas as pd
import playground
import os
import random
    ...
    with sr.Microphone(0) as source:
        ...
        try:
            ...
            return voice_data
                ...
                return "SDorry, I didn't get that:"
...
def respond(voice_data):
    if "name" in voice_data:
        ...
        data_bot_speak("I am databot made by Ankush Dujania to help wiht empolyee data")
